    ...
    \only<2>{
        \begin{figure}
            ...
            \begin{tikzpicture}[scale=0.73, every node/.style={transform shape}]
                ...
                \definecolor{blendedColor}{rgb}{0.4, 0.3, 0.24}
                ...
                % Splat 1
                \fill[red, opacity=0.4] (2.5, 0) ellipse (0.6 and 1.2);
                ...
                % Splat 2
                \fill[green, opacity=0.5] (6, 0.3) ellipse (0.7 and 1.3);
                ...
                % Splat 3
                \fill[blue, opacity=0.8] (9.5, -0.2) ellipse (0.5 and 1.0);
                \draw[blue!80!black, thick] (9.5, -0.2) ellipse (0.5 and 1.0);
...
\begin{frame}{Backward Pass: Phases 3 to 5}
    ...
    \begin{itemize}
        \item Finally, the gradients flow backward through the 3D covariance matrix assembly.
