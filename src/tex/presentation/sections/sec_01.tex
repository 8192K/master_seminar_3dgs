\begin{frame}{Why 3D Gaussian Splatting?}
    ...
    \begin{itemize}
        ...
        \item \textbf{3D Gaussians As The Next Logical Step} \\
    ...
    \pdfcomment[opacity=0]{
        ...
        - Kerbl 2023, young paper, highly influential
        \textCR
        \textCR
        - Let's first look at the agenda. After a short background section, we'll start by examining the 3D Gaussian data structure before we dissect the training procedure in more detail, focussing on the forward pass. We'll finish by showing how the rendering process works, also called novel-view synthesis.\textCR
    }
\end{frame}
