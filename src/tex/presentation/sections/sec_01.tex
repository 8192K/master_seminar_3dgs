\begin{frame}{Why 3D Gaussian Splatting?}
    ...
    \begin{itemize}
        ...
        \item \textbf{Impact on 3D Reconstruction} \\
        Real-time rendering of reconstructed scenes represents a fundamental disruption in 3D Reconstruction fascilitating many new downstream applications.
    \end{itemize}
\end{frame}
