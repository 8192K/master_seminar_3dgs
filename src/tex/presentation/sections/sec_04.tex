...
\begin{frame}{Novel-View Synthesis}
    \begin{columns}[T]
        ...
        \begin{column}{0.35\textwidth}
            \textbf{Synthesis Steps}
            \vspace{1em}
            
            \alt<1>{\textbf{\textcolor{blue}{Pre-computation}}}{\textcolor{gray}{Pre-computation}}\par\vspace{1em}
            \alt<2>{\textbf{\textcolor{blue}{Feed-Forward Execution}}}{\textcolor{gray}{Feed-Forward Execution}}\par\vspace{1em}
...
\section{Video and Discussion}

\begin{frame}{3DGS Training Videos}
    \centering
    \url{https://youtu.be/F9rgbvhSad8?t=550}\\
    \href{https://youtu.be/F9rgbvhSad8?t=550}{%
        \includegraphics[width=0.4\linewidth]{figures/video_screenshot_truck.png}%
    }\\
    \vspace{2mm}
    \url{https://youtu.be/yd40zUnr7eQ}\\
    \href{https://youtu.be/yd40zUnr7eQ}{%
        \includegraphics[width=0.4\linewidth]{figures/video_screenshot_bench.png}%
    }
\end{frame}
