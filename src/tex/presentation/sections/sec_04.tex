...
\begin{frame}{Novel-View Synthesis}
    \begin{columns}[T]
        ...
        \begin{column}{0.6\textwidth}
            ...
            \only<2>{
                From then on, generating new images is strictly feed-forward. The algorithm repeatedly executes only forward pass phases 3 to 6 (tile mapping, sorting, and rasterization) using the camera matrix of any desired novel view.
            }
            \only<3>{
