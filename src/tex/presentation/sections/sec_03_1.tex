    ...
    \only<3>{
        \begin{figure}
            ...
            \begin{tikzpicture}[every node/.style={transform shape}]
                ...
                \node[gray!60!black, font=\small\bfseries, anchor=north west] at (0.2, -8.2) {Adjacent tiles};
                ...
                \node[red!80!black, font=\footnotesize\bfseries, anchor=north] at (2.5, -5.27) {Bounding boxes};
                ...
                \node[font=\footnotesize\bfseries, purple!80!black, align=center, anchor=north] at (6.3, -7.55) {Box overlaps boundary\\(assigned to both tiles)};
