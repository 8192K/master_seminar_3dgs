            ...
            \begin{overlayarea}{\textwidth}{3cm}
                ...
                \only<3>{
                    ...
                    \begin{itemize}
                        ...
                        \item Opacity is set to a low value, and color to any RGB value.
                    \end{itemize}
                }
            \end{overlayarea}
        \end{column}
...
\begin{frame}{Forward Pass: Phases 1 \& 2}
    ...
    \begin{itemize}
        ...
        \item Raw values optimized during backpropagation are converted.
...
\begin{frame}{Forward Pass: Phase 3}
    ...
    \begin{itemize}
        ...
        \item Uses a linear affine approximation to keep the 2D Gaussian elliptic (Jacobian $J$).
        \item The 3D matrix is rotated into view space via camera matrix $W$ and then projected:
    \end{itemize}
    ...
    \begin{columns}[c]
        \begin{column}{0.33\textwidth}
            $$
            \darkmathhighlight{\Sigma_{2D} = J W \Sigma_{3D} W^{T} J^{T}}
            $$
        \end{column}
        ...
        \begin{column}{0.67\textwidth}
            ...
            \begin{figure}
                \begin{tikzpicture}[scale=0.6, every node/.style={transform shape}]
                    ...
                    \node[below right, font=\normalsize\bfseries, align=left, fill=white, fill opacity=0.7, text opacity=1, inner sep=2pt, rounded corners] 
...
\begin{frame}{Forward Pass: Phases 4 \& 5}
    \begin{columns}[c]
        \begin{column}{0.6\linewidth}
            ...
            \begin{itemize}
                \justifying
                \item The target output image is divided into a grid of tiles of $16\times16$ pixels.
                \item The algorithm calculates a 2D bounding box to map exactly which tiles a 2D Gaussian covers.
        ...
        \begin{column}{0.4\linewidth}
            ...
            \begin{figure}
                ...
                \begin{tikzpicture}[every node/.style={transform shape}]
                    ...
                    \draw[-Latex, thick, gray!80!black] (7, -0.74) -- (8.5, -1.3); 
                    \node[font=\footnotesize\bfseries, gray!80!black, align=center, anchor=south] at (7, -0.9) {Excluded\\(outside tile)};
