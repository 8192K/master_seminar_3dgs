...
Consequently, having to derive camera poses for initialization first adds significantly to the entire training process which is why other, faster COLMAP-free methods have been proposed. Also, Kerbl et al \cite{kerbl3DGaussianSplatting2023} mention that using random initialization of all 3D Gaussians yields good quality results despite longer training times.
